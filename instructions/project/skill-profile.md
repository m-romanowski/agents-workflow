...
- this file does not declare which personal skills are installed in the operator environment
- this file only defines how optional personal skills interact with repository workflow when explicitly requested
...
- use `instructions/project/skill-profile.md` to describe how optional personal skills may be activated for work in this repository
